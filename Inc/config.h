...
#define BAT_CALIB_REAL_VOLTAGE  4209      // input voltage measured by multimeter (multiplied by 100). In this case 43.00 V * 100 = 4300
#define BAT_CALIB_ADC           1683      // adc-value measured by mainboard (value nr 5 on UART debug output)
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define PRI_INPUT2              3,   0, 0, 4096, 0  // Pedal Accel        TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  ...
  #define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      #define MULTI_MODE_DRIVE_M1_RATE  50
      #define MULTI_MODE_M1_I_MOT_MAX   8
      #define MULTI_MODE_M1_N_MOT_MAX   125
